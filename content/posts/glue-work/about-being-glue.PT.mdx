---
title: "Being glue e expandir seu gráfico"
date: "2021-02-18T10:00:00.169Z"
template: "post"
draft: 
lang: "pt"
slug: "/posts/being-glue-expandir-seu-grafico/"
...
![Photo de Branko Stancevic em Unsplash](/media/glue-work/cover.jpg)

O tema sobre o qual sempre pretendo escrever nesse blog é que o desenvolvimento de software é muito mais do que código. É claro que boa parte disso é programação (caso contrário eu não estaria interessado), mas não se pode negligenciar todo o ecossistema ao seu redor. Depois de ler [o artigo](https://noidea.dog/glue) e [assistir à palestra](https://www.youtube.com/watch?v=KClAPipnKqw) de Tanya A. ([@whereistanya](https://twitter.com/whereistanya)), eu acho que ela concorda com isso. 
...
*Being glue* (numa tradução livre *ser cola*), como ela descreve, é fazer todo o trabalho paralelo que, junto com a programação, torna possível entregar features de uma forma escalável. Integrar juniors, participar da concepção de design, documentar recursos, entre outras atividades. Tudo isso é retratado por Tanya através de uma *mise en situation* que eu gostaria de desenvolver. 
...
Pode-se dizer que para fazer tal tipo de trabalho (glue work), o engenheiro deve ter um entendimento abrangente da base de código, mesmo sem implementar novas features. É possível, de fato, mas também pode estar relacionado a um tipo de sensibilidade de trabalho, ou senso comum, que desbloqueia e melhora as situações. Não estou dizendo que isto não é motivo de promoção, apenas que não é suficiente. O mesmo vale, eu diria, para um programador fantástico que, sem isso, também não seria suficiente. É como quando você joga FIFA, você vê as estatísticas de seu jogador em um gráfico de radar e quanto maior a área, mais completo é o jogador.

![Radar de habilidades](/media/glue-work/radar-chart.png)
![Plano cartesiano](/media/glue-work/cartesian-chart.png)

Visualizar o problema a partir de uma perspectiva gráfica sempre ajuda. Outra análise que poderíamos fazer é isolar as habilidades de codificação em uma dimensão e tudo mais (por exemplo, documentação, comunicação, espírito de equipe, etc.) em outra. Traçando isso em um plano cartesiano, pode-se ver que investindo apenas em uma dimensão, a área que você ocupa tende a ser menor, enquanto comparada a um cenário onde você desenvolve ambos. Isto é completude. A completude é a senioridade. É com base na completude que um sênior pode generalizar padrões e resolver novos desafios. 
