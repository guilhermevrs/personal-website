...
draft: 
lang: "pt"
slug: "/posts/ser-cola-expandir-seu-grafico/"
category: "Engenharia de software"
ogImage: "media/glue-work/cover.jpg"
description: "Engenharia de software não se limita a programação, envolvendo também muitos outros tipos de tarefas. Entretanto, assegure-se de ter tempo para programar também"
keywords: "senior engenheiros programacao habilidades"
---

![Foto de Branko Stancevic em Unsplash](/media/glue-work/cover.jpg)
...
*Being glue* (numa tradução livre *ser a cola*), como ela descreve, é fazer todo o trabalho paralelo que, junto com a programação, torna possível entregar features de uma forma escalável. Integrar juniors, participar da concepção de design, documentar recursos, entre outras atividades. Tudo isso é retratado por Tanya através de uma histórinha que eu gostaria de desenvolver. 
